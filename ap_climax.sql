...
set @delayTime='00:00:10:000'
/*minutos hacia atrás que mirará eventos a tratar a partir de inicio de programa*/
set @minutosHaciaAtrasInicial=1440 -- un dia por default al arranque
/*inicializar con las tasks por las que entra Climax*/
insert into @tasks_no values (29), (229), (284)
/*inicializar los eventos que traen imágen*/
insert into @image_events values ('CXLINK'),('CXE609'),('CXE130')
...
set @urlPhp='http://10.24.34.23/index.php?uri='
set @maxRowsProcessing=200
set @thisTask=isnull(@task_no,1000);
...
OR 
ev.aux2 is null)
and msp.raw_message like '%'+@caracterfinurl+'%'
